...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header">
        ...
        <div id="space">
            <a href="#">
                <marquee id="right" crollamount="5">特别公告:本系统为测试版本,若使用过程中发生漏洞或不足之处,请及时联系技术主管,联系方式:88888888</marquee>
            </a>
        </div>
                    ...
                    <#if permissions ? seq_contains(2)>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                    ...
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-2" data-tab="bus_car/index" target="_self"><i class="fa fa-ellipsis-h"></i><span class="layui-left-nav"> 车辆管理</span></a>
                                    </dd>
                            </dl>
                        </li>
                    </#if>
                    ...
                    <#if permissions ? seq_contains(3)>
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 业务管理</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-4" data-tab="bus_rent/index" target="_self"><i class="fa fa-user-times"></i><span class="layui-left-nav"> 出租单管理</span></a>
                                </dd>

                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3" data-tab="bus_car/info" target="_self"><i class="fa fa-exchange"></i><span class="layui-left-nav"> 汽车详情</span></a>
                                    </dd>
<#--                                    <dd>-->
