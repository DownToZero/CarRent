layui.use(['table', 'layer'], function () {
    ...
    var tableIns = table.render({
        ...
        id: "carListTable",
        cols: [[
            {field: "carnumber", title: '车牌号', fixed: "true", width: 100},
            {field: 'cartype', title: '出租类型', minWidth: 40, align: "center"},
            {field: 'color', title: '出租颜色', minWidth: 80, align: 'center'},
            {field: 'price', title: '汽车价格', minWidth: 80, align: 'center'},
            {field: 'rentprice', title: '出租价格', align: 'center'},
            {field: 'deposit', title: '出租押金', align: 'center', minWidth: 80},
            {field: 'isrenting', title: '出租状态', align: 'center', minWidth: 80,templet: function (d){
                    if (d.isrenting == 0){

                        return "<div style='color: red'>未出租</div>";
                    }else {
                        return "<div style='color: blue'>已出租</div>";
                    }
                }},
            {field: 'description', title: '出租描述', align: 'center', minWidth: 80},
