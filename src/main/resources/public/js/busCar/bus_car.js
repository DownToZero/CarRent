layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: "carnumber", title:'车牌号',fixed:"true"},
    ...
    function formatterIsRenting(isrenting){
        if(isrenting==0) {
            return "<div style='color: blue'>未出租</div>";
        } else if(isrenting==1) {
            return "<div style='color: green'>已出租</div>";
        } else {
